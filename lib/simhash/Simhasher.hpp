...
#include "../cppjieba/include/cppjieba/KeywordExtractor.hpp"
#include "jenkins.h"
...
namespace simhash
{
    ...
    class Simhasher
    {
        ...
        public:
            ...
            void make(const string& text, size_t topN, vector<pair<uint64_t, double> >& res) const
            {
            ...
            void make(const string& text, size_t topN, uint64_t& v64) const
            {
                vector<pair<uint64_t, double> > hashvalues;
                make(text, topN, hashvalues);
